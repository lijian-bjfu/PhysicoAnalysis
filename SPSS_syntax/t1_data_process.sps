...
* 2. 计算均值 (同上).
COMPUTE t1_stai = MEAN(Q1_Row1_R, Q1_Row2, Q1_Row3, Q1_Row4_R, Q1_Row5_R, Q1_Row6).
VARIABLE LABELS  t1_sta 'SATI 状态焦虑量表总均值'.
...
VARIABLE LABELS t1_smm '状态心智正念 (SMM) 均值'.
EXECUTE.
...
VARIABLE LABELS t1_sbm '状态身体正念 (SBM) 均值'.
...
VARIABLE LABELS t1_sbs '状态正念 (SBS) 均值'.
